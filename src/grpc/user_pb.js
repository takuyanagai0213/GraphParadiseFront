...
proto.userservice.UserProfile.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    followUsersList: (f = jspb.Message.getRepeatedField(msg, 5)) == null ? undefined : f
  };
...
proto.userservice.UserProfile.prototype.clearFollowUsersList = function() {
  return this.setFollowUsersList([]);
};
...
/**
 * @param {number} value
 * @return {!proto.userservice.FollowUserRequet} returns this
 */
...
/**
 * @param {?proto.userservice.ResponseStatus|undefined} value
 * @return {!proto.userservice.FollowUserResponse} returns this
*/
